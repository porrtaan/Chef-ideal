...
<div class="flex items-center gap-3 py-3 px-6 mb-[22px]"><img src="assets/images/icons/icon-add-square.svg" alt="add icon">
      ...
      <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
        <div>
          <div class="flex items-center justify-between mb-[19px]">
            <div>
              <h2 class="capitalize text-gray-1100 font-bold text-[28px] leading-[35px] dark:text-gray-dark-1100 mb-[13px]">Todas vendas</h2>
              <div class="flex items-center justify-between">
                <div class="flex items-center text-xs text-gray-500 gap-x-[11px]">
                  <div class="flex items-center gap-x-1"><img src="assets/images/icons/icon-home-2.svg" alt="home icon"><span class="capitalize">home</span></div><img src="assets/images/icons/icon-arrow-right.svg" alt="arrow right icon"><span class="capitalize text-color-brands">vendas</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="text-base leading-5 text-gray-1100 font-semibold mb-6 dark:text-gray-dark-1100">Vendas</div>
    <table class="w-full min-w-[900px]">
        <thead>
            <tr class="border-b border-neutral dark:border-dark-neutral-border pb-[15px]"> 
                ...
                <th class="font-normal text-normal text-gray-400 text-left pb-[15px] dark:text-gray-dark-400" onclick="sortTable(1)">Total<span id="arrow-1"><i class="fa-solid fa-arrows-up-down"></i></span></th>
                <th class="font-normal text-normal text-gray-400 text-left pb-[15px] dark:text-gray-dark-400" onclick="sortTable(2)">Data<span id="arrow-2"><i class="fa-solid fa-arrows-up-down"></i></span></th>
                <th class="font-normal text-normal text-gray-400 text-left pb-[15px] dark:text-gray-dark-400" onclick="sortTable(2)">Detalhes<span id="arrow-2"><i class="fa-solid fa-arrows-up-down"></i></span></th>
...
if (mysqli_num_rows($resultado) > 0) {
    while ($row = mysqli_fetch_assoc($resultado)) {
       $id_venda = $row['id_venda'];
        ...
        echo '<tr>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100">' . htmlspecialchars($row["id_venda"], ENT_QUOTES, 'UTF-8') . '</td>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100">€ ' . htmlspecialchars($row["total"], ENT_QUOTES, 'UTF-8') . '</td>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100">' . date('d/m/Y', strtotime($row['data_venda'])). '</td>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100">
        <a href="order-details.php?id_venda=' . $id_venda . '">
            <i class="fas fa-search search-icon"></i> Ver detalhes
        </a>
      </td>';
        echo '</tr>';
    }
