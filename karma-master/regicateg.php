...
label {
  ...
  <body class="w-screen relative overflow-x-hidden min-h-screen bg-gray-100 scrollbar-hide authentication-sign-in-page dark:bg-[#000]">
      <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
        <div>
        <form class="rounded-2xl bg-white mx-auto p-10 text-center max-w-[440px] my-[84px] dark:bg-[#1F2128]" action="registar_categorias_php.php" method="post" onsubmit="return validar()" name="form1">
    ...
    <h3 class="font-bold text-2xl text-gray-1100 capitalize mb-[5px] dark:text-gray-dark-1100">Adicionar categoria</h3>
    <br>
    <div>
        <!-- Nome da Categoria -->
        <label for="nome">
        ...
        <div class="form-control mb-[20px]">
            <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <input class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" type="text" placeholder="Digite aqui..." name="nome" id="nome">
            </div>
        ...
        <div class="form-control mb-[20px]">
            <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <textarea class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" name="desc" id="desc" cols="33" placeholder="Descrição aqui..."></textarea>
            </div>
