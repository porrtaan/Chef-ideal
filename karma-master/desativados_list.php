      ...
      <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
        <div>
          <div class="flex items-center justify-between mb-[19px]">
            <div>
              <h2 class="capitalize text-gray-1100 font-bold text-[28px] leading-[35px] dark:text-gray-dark-1100 mb-[13px]">Produtos desativados</h2>
              <div class="flex items-center justify-between">
                <div class="flex items-center text-xs text-gray-500 gap-x-[11px]">
                  <div class="flex items-center gap-x-1"><img src="assets/images/icons/icon-home-2.svg" alt="home icon"><span class="capitalize">home</span></div><img src="assets/images/icons/icon-arrow-right.svg" alt="arrow right icon"><span class="capitalize text-color-brands">Produtos Desativados</span>
                </div>
              </div>
            </div>
            <div class="flex"><a class="list-grid-btn flex items-center gap-x-2 rounded-l-2xl bg-neutral active px-[17px] py-[14px] dark:bg-dark-neutral-border" href="desativados_list.php"><img src="assets/images/icons/icon-row-vertical.svg" alt="row vertical icon"><span class="text-xs text-[#8083A3]">Desativados</span></a><a class="list-grid-btn flex items-center gap-x-2 bg-neutral rounded-r-2xl px-[17px] py-[14px] dark:bg-dark-neutral-border" href="product-list.php"><img src="assets/images/icons/icon-grid.svg" alt="grid icon"><span class="text-xs text-[#8083A3]">Ativados</span></a></div>
          </div>
            ...
            <table class="w-full min-w-[900px]">
              <thead>
                <tr class="border-b border-neutral dark:border-dark-neutral-border pb-[15px]"> 
                  ...
                  <th class="font-normal text-normal text-gray-400 text-center pb-[15px] dark:text-gray-dark-400" onclick="sortTable(9)">Ativar<span id="arrow-6"><i class="fa-solid fa-arrows-up-down"></i></span></th>
              </thead>
              <tbody> 
              <?php
                    include 'connect.php';
                    ...
                    $sql_produtos = "SELECT produto.*, marca.nome_marca, GROUP_CONCAT(categoria.nome_categoria SEPARATOR ', ') AS categorias
                                    ...
                                    where produto.estado = 'D'
                                    GROUP BY produto.id_prod";
                    $resultado_produtos = mysqli_query($cn, $sql_produtos);

                    while ($produto = mysqli_fetch_array($resultado_produtos)) {
                        ...
                        echo '<td style="text-align: center;">
                            <a href="update_produtod.php?id_prod=' . $produto['id_prod'] . '" 
                            onclick="return confirm(\'Tem certeza que deseja ativar este produto?\');">
