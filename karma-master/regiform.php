...
label {
  ...
  <body class="w-screen relative overflow-x-hidden min-h-screen bg-gray-100 scrollbar-hide authentication-sign-in-page dark:bg-[#000]">
      <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
        <div>
        <form class="rounded-2xl bg-white mx-auto p-10 text-center max-w-[440px] my-[84px] dark:bg-[#1F2128]" action="insertp.php" method="post" enctype="multipart/form-data" onsubmit="return validar_produto()" onchange="return validar_produto()">
    ...
    <h3 class="font-bold text-2xl text-gray-1100 capitalize mb-[5px] dark:text-gray-dark-1100">Adicionar produto</h3>
    <br>
    ...
    <div>
        ...
        <div class="form-control mb-[20px]">
            <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <input class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" type="text" placeholder="Digite aqui... " id="nome" name="nome" style="color: white;">
            </div>
    ...
    <div>
        ...
        <div class="form-control mb-[20px]">
            <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <textarea class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" id="desc" name="desc" cols="33" placeholder="Descrição aqui..."></textarea>
            </div>
    ...
    <div>
        ...
        <div class="form-control mb-[20px]">
            <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <input class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" type="text" placeholder="Digite aqui..." id="preco" name="preco" style="color: white;">
            </div>
    ...
    <div>
        ...
        <div class="form-control mb-[20px]">
            <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <input class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" type="text" placeholder="Digite aqui..." id="stock" name="stock" style="color: white;">
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="form-group">
                <div class="nk-int-st">
                    ...
                    <div id="preview2" style="margin-left: 25px;"></div>
