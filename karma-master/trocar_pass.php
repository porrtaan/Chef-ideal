        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="troca_pass_bd.php" method="POST">
                            <div class="mb-3">
                                <label for="email" class="form-label">Nova password</label>
                                <input type="hidden" name="email" value=<?= $email ?>>
                                <input type="text" class="form-control" id="email" name="password" placeholder="Digite a password" required>
                            </div>
                            <div class="d-grid">
