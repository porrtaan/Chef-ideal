...
<div class="flex items-center gap-3 py-3 px-6 mb-[22px]"><img src="assets/images/icons/icon-add-square.svg" alt="add icon">
      ...
      <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
        <div>
          <div class="flex items-center justify-between mb-[19px]">
            <div>
              <h2 class="capitalize text-gray-1100 font-bold text-[28px] leading-[35px] dark:text-gray-dark-1100 mb-[13px]">Todas as Marcas</h2>
              <div class="flex items-center justify-between">
                <div class="flex items-center text-xs text-gray-500 gap-x-[11px]">
                  <div class="flex items-center gap-x-1"><img src="assets/images/icons/icon-home-2.svg" alt="home icon"><span class="capitalize">home</span></div><img src="assets/images/icons/icon-arrow-right.svg" alt="arrow right icon"><span class="capitalize text-color-brands">marcas</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="text-base leading-5 text-gray-1100 font-semibold mb-6 dark:text-gray-dark-1100">Marcas</div>
...
if (mysqli_num_rows($resultado) > 0) {
    while ($row = mysqli_fetch_assoc($resultado)) {
        ...
        echo '<tr>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100">' . htmlspecialchars($row["id_marca"], ENT_QUOTES, 'UTF-8') . '</td>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100">' . htmlspecialchars($row["nome_marca"], ENT_QUOTES, 'UTF-8') . '</td>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100">' . htmlspecialchars($row["descricao"], ENT_QUOTES, 'UTF-8') . '</td>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100"><a href="editar_marca.php?id=' . urlencode($row["id_marca"]) . '"><i class="fas fa-edit edit-produto"></i></a></td>';
        echo '<td class="text-gray-1100 text-normal dark:text-gray-dark-1100" style="text-align: center;"><a href="eliminar_marca.php?id=' . urlencode($row["id_marca"]) . '"><i class="fas fa-trash-alt delete-produto"></i></a></td>';
        echo '</tr>';
    }
} else {
