...
label {
  ...
  <body class="w-screen relative overflow-x-hidden min-h-screen bg-gray-100 scrollbar-hide authentication-sign-in-page dark:bg-[#000]">
      <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
        ...
        <form class="rounded-2xl bg-white mx-auto p-10 text-center max-w-[440px] my-[84px] dark:bg-[#1F2128]" action="editar_marca_php.php" method="post" onsubmit="return validar()" name="form1">
    ...
    <br>
    <input type="hidden" name="id" value="<?php echo $categoria['id_marca']; ?>">
    <div>
        <label for="nome">
            <p class="text-left text-sm mb-2 text-gray-1100 dark:text-gray-dark-1100">Nome da marca</p>
        </label>
        <div class="form-control mb-[20px]">
            <div class="input-group border rounded-lg border-[#E8EDF2] dark:border-[#313442]">
                <input class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300" type="text" placeholder="Digite aqui..." name="nome" id="nome" style="color:white;" value="<?php echo $categoria['nome_marca']; ?>">
            </div>
        </div>
